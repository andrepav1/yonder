...
export const pt: Messages = {
  ...
  modes: {
    ...
    catalog: {
      ...
      hidden: {
        name: 'Destino oculto',
        blurb:
          'Encontre a capital misteriosa por pistas de distância e direção.',
      },
    },
  },

  hidden: {
    eyebrow: 'Encontre a capital oculta',
    title: 'Em algum lugar da Terra',
    lead: 'Cada palpite indica a distância — e para que lado seguir.',
    hint: (guesses) => `adivinhe capitais para se aproximar · ${guesses} tentativas`,
    away: (distance) => `a ${distance}`,
    found: 'Encontrou!',
    resultWin: (used, total) => `Encontrada em ${used}/${total}`,
    resultLose: 'Sem tentativas',
    headlineWin: 'Você encontrou',
    headlineLose: 'Quase',
  ...
  globe: {
    ...
    worldLabel: 'Globo interativo. Arraste para girar.',
    zoomIn: 'Aproximar',
    zoomOut: 'Afastar',
    reveal: {
      ...
      hidden: 'A capital oculta',
    },
    hints: {
      label: 'Dicas',
      cities: 'Mostrar cidades',
      capitals: 'Mostrar capitais',
      names: 'Revelar nomes',
    },
  },
