...
export const ja: Messages = {
  ...
  modes: {
    ...
    catalog: {
      classic: {
        name: 'クラシック',
        blurb: '都市から都市へ跳んで、合計距離を目標距離に近づけよう。',
      },
      hidden: {
        name: '隠れた目的地',
  ...
  about: {
    ...
    rules:
      'できるだけ少ない区間で、目標に十分近づけましょう。挑戦は6回で、目標を超えてもラウンドは終わりません。メニューからモードを選べば、連続記録に影響しないランダムな問題を無制限に遊べます。',
    credits:
  ...
  prompt: {
    ...
    targetLabel: '合計で到達',
    hint: (band, guesses) =>
      `都市から都市へ跳ぶ · 目標の ${band} 以内に収める · ${guesses} 回`,
  ...
  howTo: {
    title: '遊び方',
    intro:
      '毎日、出発都市と目標距離が一つずつ。都市を一つずつつないでルートを作り、各区間を足していきます — 合計を目標に十分近づけましょう。',
    step1:
      '都市を推測します。スコアは出発地からその都市までの直線距離です。もう一度推測すると、前の都市から新しい都市までの区間が加算されます。',
    step2:
      '地球儀の破線の輪が、残りの距離をそのまま示しています — その上にある都市を狙いましょう。合計が近づくにつれてホット/コールドの合図が温かくなります。',
    step3: (band, guesses) =>
      `合計を目標の前後 ${band} 以内に収めれば勝ちです。超えても失うのはその1回だけ — バーストはありません。負けるのは ${guesses} 回を使い切ったときだけ。区間が少ないほど良いスコアです。`,
    note: (min) =>
